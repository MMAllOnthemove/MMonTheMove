...
function AnalyticCard() {
  ...
  return (
    <>
      ...
      {
        analytic.map((item) => (
          <article onClick={()=>router.push(`/dashboard/${item.href}`)} className='bg-white border-t-4 border-sky-600 p-8 shadow-md rounded grid text-center cursor-pointer' key={item.id}>
