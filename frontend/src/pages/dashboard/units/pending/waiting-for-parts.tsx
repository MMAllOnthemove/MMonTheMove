...
function WaitingForParts() {
  ...
  let waitingForParts = fetchAlldata.filter((item) => {
    let filterPass = true;
  ...
  return (
    <>
      <Head>
        <title>Waiting for parts | Breakdown</title>
      </Head>
      <Navbar />
          ...
          <div className="max-h-[540px] overflow-y-auto">
            <table className="relative w-full max-w-full whitespace-nowrap text-sm text-left text-gray-500 table-auto">
              ...
              <tbody className="z-0">
                {dateFrom !== "" &&
                  dateTo !== "" &&
                  waitingForParts.map((item, index) => (
                    <tr
                      key={index}
...
export default WaitingForParts;
