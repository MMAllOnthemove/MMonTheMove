...
function WaitingForCustomer() {
  ...
  let waitingForCustomer = fetchAlldata.filter((item) => {
    let filterPass = true;
  ...
  return (
    <>
      <Head>
        <title>Waiting for customer | Breakdown</title>
      </Head>
        ...
        <Container>
          <section className="flex justify-center pt-5">
            <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl text-center">
              Waiting for customer breakdown
            </h1>
          </section>
          ...
          <div className="max-h-[540px] overflow-y-auto">
            <table className="relative w-full max-w-full whitespace-nowrap text-sm text-left text-gray-500 table-auto">
              ...
              <tbody className="z-0">
                {dateFrom !== "" &&
                  dateTo !== "" &&
                  waitingForCustomer.map((item, index) => (
                    <tr
                      key={index}
