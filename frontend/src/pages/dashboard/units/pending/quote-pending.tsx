...
function QualityPending() {
  ...
  let quotePending = fetchAlldata.filter((item) => {
    let filterPass = true;
  ...
  return (
    <>
      <Head>
        <title>Quote pending | Breakdown</title>
      </Head>
      <Navbar />
