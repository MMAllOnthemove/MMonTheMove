...
function QualityApproved() {
  ...
  let quoteApproved = fetchAlldata.filter((item) => {
    let filterPass = true;
  ...
  return (
    <>
      <Head>
        <title>Quote approved | Breakdown</title>
      </Head>
...
export default QualityApproved;
