...
function ScrapApproved() {
  ...
  let scrapApproved = fetchAlldata.filter((item) => {
    let filterPass = true;
  ...
  return (
    <>
      <Head>
        <title>Scrap approved | Breakdown</title>
      </Head>
