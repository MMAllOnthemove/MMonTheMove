...
function QualityRejected() {
  ...
  let quoteRejected = fetchAlldata.filter((item) => {
    let filterPass = true;
  ...
  return (
    <>
      <Head>
        <title>Quote rejected | Breakdown</title>
      </Head>
      <Navbar />
