...
function PartsToBeOrdered() {
  ...
  let partsToBeOrdered = fetchAlldata.filter((item) => {
    let filterPass = true;
  ...
  return (
    <>
      <Head>
        <title>Parts to be ordered | Breakdown</title>
      </Head>
      <Navbar />
          ...
          <div className="max-h-[540px] overflow-y-auto">
            <table className="relative w-full max-w-full whitespace-nowrap text-sm text-left text-gray-500 table-auto">
              ...
              <tbody className="z-0">
                {dateFrom !== "" &&
                  dateTo !== "" &&
                  partsToBeOrdered.map((item, index) => (
                    <tr
                      key={index}
...
export default PartsToBeOrdered;
