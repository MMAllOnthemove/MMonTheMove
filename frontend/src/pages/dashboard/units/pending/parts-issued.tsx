...
function PartsIssued() {
  ...
  let partsIssued = fetchAlldata.filter((item) => {
    let filterPass = true;
  ...
  return (
    <>
      <Head>
        <title>Parts issued | Breakdown</title>
      </Head>
