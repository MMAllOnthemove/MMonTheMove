...
function PendingQandA() {
  ...
  let pendingQandA = fetchAlldata.filter((item) => {
    let filterPass = true;
  ...
  return (
    <>
      <Head>
        <title>Pending Q&A | Breakdown</title>
      </Head>
