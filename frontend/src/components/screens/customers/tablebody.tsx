...
import { TCustomersTanstackTable } from '@/lib/types'
...
type TTableBody = {
    ...
    handleModifyCustomer: (data: TCustomersTanstackTable) => void;
    totalCustomers: string | number;
}
const TableBody = ({ table, handleModifyCustomer, totalCustomers }: TTableBody) => {
    return (
        <>
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    <DropdownMenuItem className='cursor-pointer'
                                        onClick={() => handleModifyCustomer(row)}
                                    >
                                        Edit customer
                                    </DropdownMenuItem>
            ...
            <tfoot>
                <tr className="border-b cursor-pointer hover:bg-gray-100">
                    ...
                    <td className="px-4 py-3 font-medium text-sm">Total customers</td>
                    <td className="px-4 py-3 font-medium text-sm">{totalCustomers}</td>
                </tr>
            </tfoot>
        </>
    )
