...
const CreateCustomerRepairshoprScreen = () => {
    ...
    const createCustomer = async () => {
        const payload = {
            // phone: phoneDetails.map((phone) => phone.number).join(", "),
            mobile: phoneDetails
                        ...
                        <main className='container p-1'>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <Button variant="outline" className='ml-auto' onClick={addPhoneRow}>
                                        Add Phone
                                    </Button>
                                </div>
                                <div>
                            ...
                            <Button variant="outline" type='button' onClick={createCustomer}>
                                Create customer
                            </Button>
                        </main>
                    </>
