...
const AddgspnDTVHATask = ({ onChange }: { onChange: (value: boolean) => void }) => {
        ...
        <div>
            <form>
                ...
                <div className="mb-3">
                    ...
                    {addDTVHATaskErrors.ticket_number && <p className="text-sm text-red-500 font-medium">{addDTVHATaskErrors.ticket_number}</p>}
                </div>
                <div className="mb-3">
                    <Label htmlFor="serial_number">Serial number</Label>
                    <Input type="text" name="serial_number" defaultValue={loadGSPNApiData ? 'Loading...' : serial_number} disabled aria-disabled />
                </div>
                <div className="mb-3">
                    ...
                    {addDTVHATaskErrors.status && <p className="text-sm text-red-500 font-medium">{addDTVHATaskErrors.status}</p>}
...
export default AddgspnDTVHATask
