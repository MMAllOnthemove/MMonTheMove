...
function UnitsPendingCard(props: IUnitsPendingCard) {
  return (
    ...
    >
      <p className="  text-slate-700 font-semibold text-md leading-none tracking-tight capitalize">
        {props.cardParagraph}
      </p>
      <h3 className=" text-4xl font-bold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl ">
        {props.cardHeading}
      </h3>
    </article>
  );
